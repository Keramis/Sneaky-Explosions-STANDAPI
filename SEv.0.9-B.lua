...
menuToggleLoop(mFunFeats, "Sticky Bomb Gun", {"se-lwc"}, "Logs where you shoot when you turn this on.", function ()
...
menuAction(mFunFeats, ">Explode all logged impacts<", {"expllog"}, "Explodes all logged coordinates.", function ()
    for i = 0, #SE_invismines do
...
menuAction(mFunFeats, ">>Clear logged impacts<<", {"cllog"}, "", function ()
    util.toast(SE_minescount .. " coordinates deleted!")
    SE_invismines = {}
    SE_minescount = 0
end)
